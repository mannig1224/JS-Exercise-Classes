...
class Car {
  ...
  drive(miles) {
    // if you can actually drive the miles by checking how much gas you currently have in tank and comparing it to the miles / milespergallon
...
class Instructor extends Lambdasian{
  constructor(args){
    super(args); // this replaces Parent.call
